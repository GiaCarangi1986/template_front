const MAIN_IP_PORT = `${process.env.REACT_APP_IP_ADDRESS}:${process.env.REACT_APP_PORT}`;
const PHOTO_IP_PORT = `${process.env.REACT_APP_IP_ADDRESS}:${process.env.REACT_APP_PHOTO_PORT}`;
